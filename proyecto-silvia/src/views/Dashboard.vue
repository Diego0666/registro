<template>
  <q-layout view="lHh Lpr lFf" class="bg-app">
    ...
    <!-- Header corregido (sin iconos de librería) -->
    <q-header elevated class="header-dark">
      <q-toolbar class="q-px-lg header-bar">
        ...
        <div class="row items-center no-wrap q-ml-sm">
          <div class="text-h6 text-grey-2">Statistics</div>
          <div class="text-subtitle1 text-yellow-6 text-weight-bold q-ml-md">USUARIO</div>
        </div>
        ...
        <q-btn color="yellow-6" text-color="black" class="q-ml-md" no-caps label="Upgrade" />
    ...
    <!-- Page -->
    <q-page-container>
      <q-page class="q-pa-xl page-dark">
        <div class="dashboard-grid">
          <!-- Website traffic -->
          <q-card class="card-dark highlight">
            <q-card-section>
              <div class="text-caption text-grey-5 q-mb-xs">Website traffic</div>
          ...
          <q-card class="card-dark">
            <q-card-section>
              <div class="row items-center justify-between q-mb-sm">
                <div class="text-subtitle2 text-grey-4">Bounce Rate</div>
                <q-btn dense flat round class="text-grey-5">⋯</q-btn>
              </div>
              <div class="calendar-row q-mb-md">
                <div class="day">Mon<br><span>2</span></div>
                <div class="day active">Tue<br><span>3</span></div>
                <div class="day">Wed<br><span>4</span></div>
              </div>
              <div class="text-h5 text-grey-2 q-mb-xs">23%</div>
              <div class="text-caption text-grey-5">+10% Since last day</div>
            </q-card-section>
          </q-card>
          ...
          <q-card class="card-dark">
            <q-card-section>
              <div class="row items-center justify-between">
                ...
                <q-btn flat dense no-caps class="text-grey-5">Details</q-btn>
              </div>
              <div class="text-h5 text-yellow-6 q-mt-sm">283%</div>
              <div class="sparkline q-mt-md"></div>
              <div class="text-caption text-grey-5 q-mt-xs">Return On Investment</div>
            </q-card-section>
          </q-card>
          ...
          <q-card class="card-dark flex flex-center">
            <div class="text-center">
              ...
              />
              <div class="q-mt-sm">
                <q-badge color="yellow-6" text-color="black" class="badge-pill">Web Score with AI</q-badge>
              </div>
            </div>
          </q-card>
...
/* Toolbar compacto y consistente */
